...
We want to see the crime number vs category between different specific locations.
...
Next take a look at the possible change of the number of different types of the crimes and see if there would present a certain trend.
...
Combine the crime types with locations together with corresponding boroughs to see correlations among the dataset.
